...
define( 'CMB_META_BOX_URL', SLICETHEME_URL . '/admin/metaboxes/' );
		...
		foreach ( $this->_meta_box['fields'] as $field ) {
			...
			switch ( $field['type'] ) {
				...
				case 'slider':
					...
					$attachments = get_posts($args);
					if ($attachments) {
						echo '<div class="cmb_upload_status">';
						foreach ($attachments as $attachment) {
							echo '<div class="img_status">';
							echo '<img src="', wp_get_attachment_url($attachment->ID, 'thumbnail', 0, 0, 'Download'), '" alt="" />';
							echo '<a href="#" class="cmb_remove_file_button" rel="', $attachment->ID, '">Remove Image</a>';
							echo '</div>';
						}
						echo '</div>';
					}
